...
public class QualysController {
	...
	public ResponseEntity<String> checkAndSaveQualysCred(@PathVariable("uname") String uname,@PathVariable("pwd") String pwd) {
	...
	@GetMapping(path = "/testone" , produces = "application/json") 
	public ResponseEntity<String> trigger() 
	{
		LOGGER.info("Invoked Trigger"); 
		String containerProp =  qualysGetContainerService.getContainerById("3ce9346709af"); 
	...
	/*
	 * @GetMapping(path = "/testtwo" , produces = "application/json") public
	 * ResponseEntity<Object> test() { LOGGER.info("Invoked getAllContainers");
	 * 
	 * @SuppressWarnings("rawtypes") HashMap containerProp =
	 * qualysGetAllContainersService.getTest();
	 * 
